plot3<-function(){
  ...
  lines(as.POSIXct(p[,10], origin="1970-01-01", tz="UTC"),as.numeric(as.character(p[,8])),col="red")
  lines(as.POSIXct(p[,10], origin="1970-01-01", tz="UTC"),as.numeric(as.character(p[,9])),col="blue")
  legend("topright",col=c("black","blue","red"),lty,lwd = 2, cex = 1.2, legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
  dev.off()
